...
export class HealthService {
  ...
  ): Observable<HttpResponse<HealthStatus>>;
  public healthGetLiveliness(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<HealthStatus>>;
  public healthGetLiveliness(
    observe: any = 'body',
    ...
    return this.httpClient.get<HealthStatus>(
      `${this.configuration.basePath}/api/health/live`,
      {
  ...
  public healthGetReadiness(
    ...
    return this.httpClient.get<HealthStatus>(
      `${this.configuration.basePath}/api/health/ready`,
      {
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
