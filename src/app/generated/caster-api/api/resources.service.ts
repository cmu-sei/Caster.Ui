...
export class ResourcesService {
  ...
  public importResources(
    workspaceId: string,
    importResourceCommand?: ImportResourceCommand,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json';
    }
  ): Observable<ResourceCommandResult>;
  public importResources(
    workspaceId: string,
    importResourceCommand?: ImportResourceCommand,
    observe?: 'response',
  ...
  ): Observable<HttpResponse<ResourceCommandResult>>;
  public importResources(
    workspaceId: string,
    importResourceCommand?: ImportResourceCommand,
    observe?: 'events',
  ...
  ): Observable<HttpEvent<ResourceCommandResult>>;
  public importResources(
    workspaceId: string,
    importResourceCommand?: ImportResourceCommand,
    observe: any = 'body',
    ...
    if (workspaceId === null || workspaceId === undefined) {
      throw new Error(
        'Required parameter workspaceId was null or undefined when calling importResources.'
      );
    }
    ...
    return this.httpClient.post<ResourceCommandResult>(
      `${this.configuration.basePath}/api/workspaces/${encodeURIComponent(
        String(workspaceId)
      )}/resources/actions/import`,
  ...
  public removeResources(
    workspaceId: string,
    removeResourcesCommand?: RemoveResourcesCommand,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json';
  ...
  public removeResources(
    ...
    if (workspaceId === null || workspaceId === undefined) {
      throw new Error(
        'Required parameter workspaceId was null or undefined when calling removeResources.'
      );
    }
